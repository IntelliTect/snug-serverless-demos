...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *SnugLambdaDemo*):
...
Execute unit tests
```
    cd "SnugLambdaDemo/test/SnugLambdaDemo.Tests"
    dotnet test
```

Deploy application
```
    cd "SnugLambdaDemo/src/SnugLambdaDemo"
